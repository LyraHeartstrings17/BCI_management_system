...
public:
  ...
  */
  ...
  void setTickVector(QVector<double>);
  void setTickVectorLabels(QVector<QString>);
...
class QCP_LIB_DECL QCustomPlot : public QWidget
{
  virtual void QCustomPlot::keyPressEvent(QKeyEvent *e)
  {
    ...
    if(e->key() == Qt::Key_Escape) {
      ...
      xAxis->setRange(0, 20000); // 设置x轴范围为0到10
      yAxis->setRangeLower(-150); // 设置y轴范围的下限为-5
      yAxis->setRangeUpper(750); // 设置y轴范围的上限为5
//      this->rescaleAxes();
      this->replot();
    }
  }
