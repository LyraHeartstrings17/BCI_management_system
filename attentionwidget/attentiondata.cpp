...
AttentionData::AttentionData(QObject *parent) : QObject(parent)
{
}

void AttentionData::setPath(QString path)
{
    this->gamefile_path=path;
}

void AttentionData::setBCIPath(QString name)
{
    this->bci_save_path=name;
}

void AttentionData::readGameFinishData()
{
...
bool  AttentionData::readGameFile(QString name)
{
...
QList<double>AttentionData::getEmotionValue()
{
    QList<double> value=emotion_max_value;
    emotion_max_value.clear();
    return value;
}
QList<double>AttentionData::getPericeiveValue()
{
...
void AttentionData::saveFinishData()
{
